        ...
        <div className="bg-[#1d1d1d] dark:bg-[#ffff] md:py-10 ">
          ...
          <div className="lg:mx-28 lg:my-20">
            <div className="mx-5 text-center sm:text-start flex flex-col sm:flex-row gap-5 items-center justify-between my-5">
              <div className="border border-[#1ec6004b] bg-[#000000] dark:bg-[#fafafa]   border-[#1ec600fa] shadow-md shadow-[#1fc600] shadow-md rounded-lg hover:border hover:border[#1fc600] flex flex-col gap-4 p-5 w-full ">
                ...
                <div className="font-quicksand text-lg text-left  md:text-center text-left ">
