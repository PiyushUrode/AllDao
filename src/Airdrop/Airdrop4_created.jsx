...
const Airdrop4_created = () => {
  ...
  return (
    <div
    id="div2"
    className="mt-2 border border-[#1fc6006b] flex flex-col items-center justify-center w-full h-[20vh] bg-black dark:bg-white text-white dark:text-black text-center rounded-lg shadow-lg"
  >
...
export default Airdrop4_created