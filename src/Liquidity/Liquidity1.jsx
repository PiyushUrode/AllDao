...
const Liquidity1 = () => {
  ...
  return (
    <>
    <div className="flex lg:p-10 p-1 mt-10 md:ml-[6%] md:mr-[2%]">
      <div className="flex flex-col w-full">
        ...
        >
          <div className="flex flex-col  w-1/2">
            <input
              ...
              className="w-full p-2 border border-[#1ec600b8] rounded-lg bg-black dark:bg-white text-white dark:text-black"
            />
          </div>
          <div className="relative w-1/2">
            <div
              onClick={toggleDropdown}
              className="flex items-center text-[#1fc600] font-medium justify-between p-2 border rounded-lg border-[#1ec600b8] bg-black dark:bg-white text-white dark:text-black cursor-pointer text-center"
            >
        ...
        <div className="flex flex-col w-full justify-center md:px-5 md:py-5" id="table">
          <table className="w-full border-collapse  ">
            <thead>
              <tr className="bg-black dark:bg-white text-white dark:text-black border border-[#1ec60021] text-left">
            ...
            <tbody className="">
              {paginatedData.map((row, index) => (
                <tr key={index} className="hover:bg-[#1ec60011] text-white dark:text-black font-semibold">
                  <td className=" border border-[#1ec60021] px-4 py-2">
                    {row.token}
                  </td>
                  <td className=" border border-[#1ec60021] px-4 py-2">
                    {row.amount}
                  </td>
                  <td className=" border border-[#1ec60021] px-4 py-2 text-[#1fc600] cursor-pointer">
                    {row.view}
                  </td>
                </tr>
              ))}
